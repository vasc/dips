...
/**
	 * 
	 */
	private static final long serialVersionUID = 4086267922219492278L;
...
public ParsedProperties( List<String> pars){
	super(pars.toArray(new String[pars.size()]));
}
