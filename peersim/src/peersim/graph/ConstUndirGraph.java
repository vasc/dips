...
public class ConstUndirGraph implements Graph {
	 ...
	 * them too. The given graph is stored by reference (not cloned) so it
	 ...
	 * Random()); ConstUndirGraph ug = new ConstUndirGraph(net); for(int i=0;
	 * i<net.size(); ++i) System.err.println(
	 ...
	 * System.err.print(ug.isEdge(i,j)?"W ":"+ "); System.err.println(); }
	 * 
