...
/**
 * Implements a graph which uses the neighbour list representation. No multiple
...
public class NeighbourListGraph implements Graph, java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1872391530849446767L;

	/** Contains the objects associated with the node indexes. */
	 ...
	 * the cost of memory (node that the edge lists typically use much more
	 * memory than this anyway). Note that the nodes vector is still necessary
	 ...
	 *             if the size was specified at construction time.
	 */
