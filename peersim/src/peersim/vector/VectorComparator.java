 ...
 * an array of nodes based on method <code>getValue</code> associated to the
 * protocol <code>pid</code>:
 * 
 * <PRE>
 ...
 * </PRE>
 * 
 * Note that differently from other classes in this package, VectorComparator is
 * declared programmatically in the code and not in the configuration file. It
 * is included in this package because it shares the same philosophy of the
 * other classes.
 * 
...
public class VectorComparator implements Comparator<Object> {
	...
	public int compare(Object o1, Object o2) {
		try {
			Comparable<Comparable<?>> c1 = (Comparable<Comparable<?>>) method
					.invoke(((Node) o1).getProtocol(pid));
			Comparable<?> c2 = (Comparable<?>) method.invoke(((Node) o2)
					.getProtocol(pid));
